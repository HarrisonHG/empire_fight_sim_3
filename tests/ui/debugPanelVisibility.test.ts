...
function individualSnapshot(
  ...
  return {
    ...
    effectiveGuardReadinessFixedPoint: 10_000,
    guardReadinessRecoveryPerTick: 100,
    guardReadinessSpentThisTick: 0,
    guardReadinessRecoveredThisTick: 0,
    guardReadinessOffensivelySuppressed: false,
    rearDesperateDefenceApplied: false,
