  ...
  it("derives compact side totals from authoritative unit summaries", () => {
    ...
    expect(summaries).toMatchObject([
      ...
      },
      {
        ...
        reservedHerbs: 0,
        energyActive: 20,
        energyAverageRatioFixedPoint: 9_995,
        energyMinimumRatioFixedPoint: 9_994,
        energyFresh: 20,
        energyWorking: 0,
        energyWinded: 0,
        energySpent: 0,
        energyResting: 0,
        units: [
          { unitId: 201, active: 10, averageRatioFixedPoint: 9_996 },
          { unitId: 202, active: 10, averageRatioFixedPoint: 9_994 },
        ],
      },
    ]);
  });
