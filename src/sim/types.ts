...
export interface LiveCombatDebugIndividualSnapshot {
  ...
  readonly energyMovementBaseExpenditureThisTick?: number;
  readonly energyDragSurchargeThisTick?: number;
  readonly energyArmourBurdenPoints?: number;
  readonly energyHeldShieldBurdenPoints?: number;
  readonly energyPrimaryWeaponBurdenPoints?: number;
  readonly energyTotalBurdenPoints?: number;
  readonly energyBurdenExertionMultiplierPercent?: number;
  readonly energyMissingGlobalHitsAtProjection?: number;
  readonly energyInjuryExertionMultiplierPercent?: number;
  readonly energyAttackExpenditureRequestedThisTick?: number;
  readonly energyAttackBaseExpenditureThisTick?: number;
  readonly energyDefenceExpenditureRequestedThisTick?: number;
  readonly energyDefenceBaseExpenditureThisTick?: number;
  readonly energyTotalExpenditureRequestedThisTick?: number;
  readonly energyExpenditureAppliedThisTick?: number;
  readonly energyExertionModifierProjectionTickUsed?: number | null;
